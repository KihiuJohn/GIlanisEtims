...
// Type: PX.Objects.CA.PaymentMethodExtEtims
...
public class PaymentMethodExtEtims : PXCacheExtension<
#nullable disable
PaymentMethod>
{
  [PXDBString(25, IsUnicode = true, InputMask = "")]
  [PXUIField(DisplayName = "ZRA Payment Method")]
  ...
  public abstract class usrKraPaymentCode : 
    ...
    #nullable disable
    PaymentMethodExtEtims.usrKraPaymentCode>
  {
  }
}
